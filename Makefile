...
TEXT1 		:= Eigenmath DS
TEXT2 		:= using Eigenmath 136
TEXT3 		:= eigenmatds.sourceforge.net
ICON 		:= -b $(CURDIR)/../logo.bmp
LOGO		:= -o $(CURDIR)/../logo_e.bmp

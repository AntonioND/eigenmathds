...
namespace WoopsiUI {
	...
	/**
	 * Class providing a key for the MathKeyboard class.
	 */
	class MathKey : public Button {
	public:
		 ...
		 */
		MathKey(s16 x, s16 y, u16 width, u16 height, const char* text, const KeyType keyType = KEY_ALPHA_NUMERIC_SYMBOL, FontBase* font = NULL);
		 ...
		 * @param font The font that the button should use.
		 */
		MathKey(s16 x, s16 y, u16 width, u16 height, const char* normalText, const char* shiftText, const char* controlText, const char* shiftControlText, const char* capsLockText, const char* controlCapsLockText, const KeyType keyType = KEY_ALPHA_NUMERIC_SYMBOL, FontBase* font = NULL);
		 ...
		 * @param capsLockText The text for the key to display when caps lock is held.
		 * @param controlCapsLockText The text for the key to display when caps lock and control are held.
		 * @param functionText The text for the key to do a function.
		 * @param keyType The type of key.
		 * @param font The font that the button should use.
		 */
		
		MathKey(s16 x, s16 y, u16 width, u16 height, const char* normalText, const char* shiftText, const char* controlText, const char* shiftControlText, const char* capsLockText, const char* controlCapsLockText, const char* functionText, const KeyType keyType = KEY_ALPHA_NUMERIC_SYMBOL,FontBase* font = NULL);
		...
		MathKey(s16 x, s16 y, u16 width, u16 height, const char glyph, const KeyType keyType = KEY_ALPHA_NUMERIC_SYMBOL, FontBase* font = NULL);
	...
	protected:
		 ...
		 */
		inline MathKey(const MathKey& key) : Button(key) { };
	};
}

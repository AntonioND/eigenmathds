...
namespace WoopsiUI {
	 ...
	 */
	class KeyPad : public AmigaWindow {
	public:
		 ...
		 */
		KeyPad(s16 x, s16 y, u16 width, u16 height, const char* title, u32 flags, u32 windowFlags, FontBase* font = NULL);
		 ...
		 */
		inline const MathKey* getLastKeyClicked() const { return _lastKeyClicked; };
	...
	protected:
		MathKey* _lastKeyClicked;		/**< Pointer to the last key clicked */
		MathKey* _shiftKey;			/**< Pointer to the shift key */
		MathKey* _controlKey;			/**< Pointer to the control key */
		MathKey* _capsLockKey;		/**< Pointer to the caps lock key */
		 ...
		 * Destructor.
		 */
		virtual inline ~KeyPad() { };

		/**
		 * Copy constructor is protected to prevent usage.
		 */
		inline KeyPad(const KeyPad& keyboard) : AmigaWindow(keyboard) { };
	};
}

...
namespace WoopsiUI {
	...
	protected:
		...
		static WDynamicArray<WoopsiTimer*> _vblListeners;	/**< Array of timers that receive VBL events */
		static WDynamicArray<Gadget*> _deleteQueue;			/**< Array of gadgets awaiting deletion */

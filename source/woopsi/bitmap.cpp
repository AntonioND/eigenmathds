...
void Bitmap::floodFill(s16 x, s16 y, u16 newColour) {
	...
	// Initalise stack
	WDynamicArray<s32>* stack = new WDynamicArray<s32>();
...
bool Bitmap::popStack(s16* x, s16* y, WDynamicArray<s32>* stack) { 
	if (stack->size() > 0) { 
...
void Bitmap::pushStack(s16 x, s16 y, WDynamicArray<s32>* stack) {

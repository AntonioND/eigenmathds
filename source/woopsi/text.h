...
namespace WoopsiUI {
	...
	private:
		...
		WDynamicArray<u32> _linePositions;			/**< Array containing start indexes of each wrapped line */
		WDynamicArray<LongestLine> _longestLines;	/**< Array containing data describing successively longer wrapped lines */
